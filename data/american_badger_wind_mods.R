...
#write.csv(final_table, "badger_turbine_interior.csv", row.names = FALSE)

#write.csv(final_table, "badger_turbine_vis.csv", row.names = FALSE)

#write.csv(final_table, "badger_turbine_dist.csv", row.names = FALSE)

#write.csv(final_table, "badger_turbine_density.csv", row.names = FALSE)

#write.csv(final_table, "badger_turbine_rd_dist.csv", row.names = FALSE)

#write.csv(final_table, "badger_turbine_rd_density.csv", row.names = FALSE)
